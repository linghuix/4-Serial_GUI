...
dir = 'D:\1-embed\4-Serial_GUI\fig\calibration\';
suffix = '_cali.mat';
...
%% ping3和ping4为另一个病例，用ping3和ping4作为test集，可以检测模型泛化能力

%name = {'adult_gril_nor2','ping1-2','ping2-2'};%'ping3-4','ping4-4'
%Label = [NORMAL PING PING];

%%

% name = {'adult_gril_nor2','adult_gril_toein1','adult_gril_toein2','adult_gril_toeout1','adult_gril_toeout2' ,'s1','s2','ping1-2','ping2-2','ping3-4','ping4-4'};
% Label = [NORMAL TOEIN TOEIN TOEOUT TOEOUT STATIC STATIC PING PING PING PING];
...
save('D:\1-embed\4-Serial_GUI\分类模型训练\tmp\features_cali.mat','group');         % 行 为一个样本
