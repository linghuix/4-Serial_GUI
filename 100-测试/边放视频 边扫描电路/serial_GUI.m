...
function serial_GUI_OpeningFcn(hObject, ~, handles, varargin)
    ...
    global maxNum J K vid
    global pause showfigure
...
function OpenSerial_Callback(hObject, eventdata,handles)
    ...
    global COM rate Stopbit terminator hfig
...
function ReceiveCallback( ~, ~,handles)
    global s
    global x x1 y1 wc Ts data after wcmin h h2 vid hfig
    global J K
    global pause
